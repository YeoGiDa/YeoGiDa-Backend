    ...
    static class InitService {
        ...
        public void doInit1() {
            ...
            Place place1 = Place.builder()
                    ...
                    .latitude(37.5730556D)
                    .longitude(126.9833333D)
                    .tag("카페")
                    .trip(trip1)
                    .build();
            ...
            Place place2 = Place.builder()
                    ...
                    .latitude(37.5731157D)
                    .longitude(126.9697643D)
                    .tag("숙소")
                    .trip(trip1)
                    .build();
            ...
            Place place4 = Place.builder()
                    ...
                    .star(2F)
                    .address("서울시 강남구 34-1")
                    .latitude(37.5390734D)
                    .longitude(126.8556963D)
                    .tag("식당")
                    .trip(trip2)
                    .build();
            ...
            Place place5 = Place.builder()
                    ...
                    .latitude(37.5211141D)
                    .longitude(126.9239719D)
                    .tag("관광지")
                    .trip(trip3)
                    .build();
            ...
            Place place6 = Place.builder()
                    ...
                    .star(1F)
                    .address("제주도 어디 34-1")
                    .latitude(37.5306293D)
                    .longitude(126.9238056D)
                    .tag("관광지")
                    .trip(trip2)
                    .build();
            ...
            Place place7 = Place.builder()
                    ...
                    .star(2F)
                    .address("부산광역시 어디 34-1")
                    .latitude(37.4941883D)
                    .longitude(127.016567D)
                    .tag("술집")
                    .trip(trip2)
                    .build();
            ...
            Place place8 = Place.builder()
                    ...
                    .star(3.5F)
                    .address("서울 어디 34-1")
                    .latitude(37.4987872D)
                    .longitude(127.0289786D)
                    .tag("숙소")
                    .trip(trip2)
                    .build();
            ...
            Place place9 = Place.builder()
                    ...
                    .latitude(37.7557287D)
                    .longitude(128.8986147D)
                    .tag("카페")
                    .trip(trip2)
                    .build();
            ...
            Place place10 = Place.builder()
                    ...
                    .star(1.5F)
                    .address("서울 어디 34-1")
                    .latitude(37.7542451D)
                    .longitude(128.8901757D)
                    .tag("쇼핑")
                    .trip(trip2)
                    .build();
            ...
            Place place11 = Place.builder()
                    ...
                    .star(4.5F)
                    .address("강릉 어디 34-1")
                    .latitude(33.3002515D)
                    .longitude(126.5801543D)
                    .tag("기타")
                    .trip(trip2)
                    .build();
