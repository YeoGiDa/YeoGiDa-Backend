...
public class SlackService {
    ...
    public void stackBlock(ReportRequestDto reportRequestDto) throws IOException {
        ...
        if(reportRequestDto.getType().equals("MEMBER")) {
        ...
        } else if(reportRequestDto.getType().equals("TRIP")) {
        ...
        } else if(reportRequestDto.getType().equals("PLACE")) {
        ...
        } else if(reportRequestDto.getType().equals("COMMENT")) {
